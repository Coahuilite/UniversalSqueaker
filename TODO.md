...
- Text fit + localization landed 2026-09-02b (`4d80aad`); vacuous height axis closed 2026-09-03 (`8937044`+`bb6f0d3`); composite popup path closed 2026-09-04 (`ae4e77c` + lib `44b00c5`); desync + band calibration 2026-09-04b (`e6b4f11` + lib `b2006a0`, ptrace half lib `9a197a2`); filter clock fix 2026-09-04d (`3727e58`); filter labels localized 2026-09-04e (`d493989`).
