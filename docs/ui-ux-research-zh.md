...
- 最低分辨率：800×600（硬下限，不支持更低）
- 常规支持：720p / 1080p / 1440p
- 帮助按钮不可接受，右侧帮助面板应始终保留

三栏宽度按窗口宽度响应式收缩：

| 窗口宽度 | 左导航 | 右帮助 | 中间内容（估算） |
|---|---|---|---|
| ≥1200 | 176 | 200 | 800+ |
| ≥1000 | 168 | 180 | 约 640 |
| 800 | 152 | 160 | 约 466 |
...
- 窗口 = 800×600
- 标题栏 56、页脚 28、安全边距后内容高约 496
- 三栏占用：152 + 12 + 466 + 12 + 160 = 802（可微调到 800）
- 中间 466px 足够单列连续滚动。
